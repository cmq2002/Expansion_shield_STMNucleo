...
//#define SLAVE_ADDRESS_LCD 				78 // change this according to ur setup
//
//#define PCF8574_SLAVE_ADDRESS 			78 ///< PCF8574 Default I2C Slave Address
//
//
...
//
//#define RS  							0b00000001 // P0 : DB4 bit
//#define RW  							0b00000010 // P1 : DB5 bit
//#define EN  							0b00000100 // P2 : DB6 bit
//#define BL  							0b00001000 // P3 : DB7 bit
//#define DB4 							0b00010000 // P4 : Enable bit
//#define DB5							    0b00100000 // P5 : R/W bit
//#define DB6							    0b01000000 // P6 : RS bit
//#define DB7							    0b10000000 // P7 : BACKLIGHT bit
//
//
...
//	HAL_I2C_Master_Transmit(&hi2c1, (uint16_t)78, (uint8_t *) initData, 1, 0xffff);
//	HAL_Delay(100);
//}
//
//void FaBoLCD_PCF8574(uint8_t addr)
...
//  HAL_I2C_Master_Transmit(&hi2c1, (uint16_t)0x4E, (uint8_t *) initData, 1, 0xffff);
//  HAL_Delay(100);
//  init();
